...
mmsh_t*   mmsh_connect (mms_io_t *io, void *data, const char *url_, const char *host, const char *uri,const char *query,int port,int bandwidth);
...
int      mmsh_get_eos(mmsh_t *instance);
